...
<x-sidebar-dashboard>
    ...
    <ul class="pb-2 space-y-2">
        ...
        <x-sidebar-menu-dashboard routeName="manager.product" title="Product"
        ...
        <x-sidebar-menu-dashboard routeName="manager.stock" title="Stock"
        ...
        <x-sidebar-menu-dashboard routeName="manager.supplier" title="Suplier"
       ...
       <x-sidebar-menu-dashboard routeName="manager.laporan" title="Laporan"
