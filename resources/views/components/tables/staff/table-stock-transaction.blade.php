            ...
            <table class="w-full divide-y divide-gray-200 table-auto dark:divide-gray-600">
                ...
                <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                    @forelse ($stockTransaction as $item)
                        ...
                        <div id="transaction-{{ $item['id'] }}" tabindex="-1"
                                    ...
                                    <div class="">
                                        <div class="flex justify-between w-full p-2 px-4">
                                            <h3 class="font-semibold text-lg text-gray-800 dark:text-gray-400">Stock
                                                Confirmation</h3>
                                            <button type="button" data-hide-modal="transaction-{{ $item['id'] }}"
                                                class="text-gray-200">
                                                <i class="fa-solid fa-xmark"></i>
                                            </button>
                                        </div>

                                        <div class="p-2 px-4 text-gray-800 dark:text-gray-400 divide-y dark:divide-gray-600">
                                            <div class="pb-2  font-medium">Transaction Details</div>
                                            <div class="py-2">
                                                <div class="flex justify-between mb-3">
                                                    <div class="">Product name :</div>
                                                    <span  class="inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-full text-xs bg-gray-100 text-gray-800 dark:bg-gray-800/30 dark:text-gray-500">
                                                        {{ $item->product->name }}
                                                    </span>
                                                </div>
                                                <div class="flex justify-between mb-3">
                                                ...
                                                <div class="flex justify-between mb-3">
                                                    ...
                                                    <span  class="inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-gray-100 text-gray-800 dark:bg-gray-800/30 dark:text-gray-500">
                                                        {{ $item->quantity }}
                                                    </span>
                                                </div>
                                                <div class="flex justify-between mb-3">
                                            ...
                                            <div class=" py-2 font-medium">
                                                <h3 class="font-normal text-base text-gray-800 dark:text-gray-400 mb-2">Notes</h3>
                                                <textarea rows="4" class="block p-2.5 w-full text-sm text-left text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" readonly>{{ $item->notes }}</textarea>
                                            </div>
                                        </div>
                                        <div class="flex justify-end border-t dark:border-gray-600 p-2 py-3 gap-1">
                                            <button data-hide-modal="transaction-{{ $item['id'] }}" type="button"
                                                class="px-4 py-2 text-sm font-medium focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 rounded-lg dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">Cancel</button>
                                            <form action="{{ route('admin.product.data-produk.delete-selected') }}"
