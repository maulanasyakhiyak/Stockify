...
@section('js')
    ...
    @vite(['resources/js/manager/stock.js'])
@endsection
@section('other_meta')
...
@section('content')
        ...
        <div class="flex flex-col">
            ...
            <div class="relative bg-white shadow dark:bg-gray-800 sm:rounded-lg">
                <div class="flex flex-col items-center justify-between p-4 space-y-3 md:flex-row md:space-y-0 md:space-x-4">
                    ...
                    <div
                        class="relative flex flex-col items-stretch justify-end w-full space-y-2 md:w-auto md:flex-row md:space-y-0 md:items-center md:space-x-3">
                                ...
                                <div class="flex flex-col gap-2">
                                    ...
                                    <div class="w-full">
                                        <div class="relative w-full">
                                            ...
                                            <input type="text" id="simple-search-filter" name="search"
                                                value="{{ $filter['search'] }}" data-search-result-target="target"
                        ...
                        <button type="button" data-drawer-target="drawer-add-transaction"
                            data-drawer-show="drawer-add-transaction" aria-controls="drawer-add-transaction"
    ...
    <div id="drawer-add-transaction"
        ...
        <button type="button" data-drawer-dismiss="drawer-add-transaction" aria-controls="drawer-add-transaction"
        ...
        <form action="{{ route('manager.stock.store') }}" method="POST" class="overflow-x-auto h-5/6 p-1  "
            enctype="multipart/form-data">
            @csrf
            <div class="space-y-4">
                <div class="relative">
                    <label for="product_sku" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Product
                        SKU</label>
                    <input type="text" name="product_sku" id="product_sku" data-search-result-target="product_sku_target"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        placeholder="Type product SKU" autocomplete="off" value="{{ old('product_sku') }}">
                    <ul id="product_sku_target"
                        class="w-full rounded-lg hidden absolute border shadow-sm overflow-hidden dark:border-gray-600"
                        style=""></ul>
                    @error('product_sku')
                ...
                <div>
                    ...
                    <select id="type" name="type"
                        ...
                        <option {{ old('type') ?? 'selected' }} hidden>Select type of transaction</option>
                ...
                <div>
                    ...
                    <input type="text" name="quantity" id="quantity"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        placeholder="insert quantity" value="{{ old('quantity') }}">
                    @error('quantity')
                        <span class="text-red-500">{{ $message }}</span>
                    @enderror
                </div>
                <div class="bottom-0 left-0 flex justify-center w-full pb-4 space-x-4 md:px-4 md:absolute">
                    ...
                    <button type="button" data-drawer-dismiss="drawer-add-transaction"
                        aria-controls="drawer-add-transaction"
