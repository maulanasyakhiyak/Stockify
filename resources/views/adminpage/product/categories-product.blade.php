...
<div class="grid grid-cols-1 gap-4 p-4">
    <div class="flex flex-col">
        ...
        <x-tables.admin.category.table-category :categories="$categories"
            routeUpdate="admin.product.categories-produk.update" routeDelete="admin.product.categories-produk.delete" />
    ...
    <div id="drawer-create-product-default"
        ...
        <form action="{{ route('admin.product.categories-produk.add') }}" method="POST" class="overflow-x-auto h-5/6" enctype="multipart/form-data">
            @csrf
            <div class="space-y-4">
                <div>
                    <label for="name"
