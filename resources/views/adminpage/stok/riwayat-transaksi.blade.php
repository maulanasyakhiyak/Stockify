                                ...
                                <div class="flex flex-col gap-2">
                                    ...
                                    <div class="flex justify-between text-gray-900 dark:text-gray-50">
                                        ...
                                        <div class="p-2 flex gap-4 text-sm">
                                            <button class="hover:underline ">Apply</button>
                                    ...
                                    <div class="w-full">
                                        <form class="flex items-center">
                                            ...
                                            <div class="relative w-full">
                                                ...
                                                <input type="text" id="simple-search-filter"
                                                    class="block w-full p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    ...
                                    <div class="">
                                        ...
                                        <div class="hidden p-2 border border-b-0 dark:border-gray-600" id="filter-status" data-hidden="true">
                                        ...
                                        <div class="hidden p-2 border dark:border-gray-600" id="filter-type" data-hidden="true">
                                            <ul class="space-y-3 text-sm text-gray-700 dark:text-gray-200"
                                        ...
                                        <button type="button" data-filter-collapse="filter-date"
                                            ...
                                            range</button>
                                        <div class="hidden p-2 border dark:border-gray-600" id="filter-date" data-hidden="true">
                                        ...
                                        <div class="hidden p-2 border dark:border-gray-600" id="filter-type3" data-hidden="true">
                                            asdadasdad
                                        </div>
                                    </div>
