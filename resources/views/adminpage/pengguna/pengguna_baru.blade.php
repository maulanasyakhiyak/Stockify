...
<script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      const choices = new Choices(selectElement, {
        searchEnabled: false, // Nonaktifkan fitur pencarian
      itemSelectText: '',  // Hilangkan teks bantuan "Klik untuk memilih"
      shouldSort: false,   // Jangan urutkan opsi
                ...
                <form class="w-full p-4">
                    ...
                    <div class="grid md:grid-cols-2 md:gap-6">
                        ...
                        <div class="relative z-0 w-full mb-5 group">
                                ...
                                <select class="block py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-gray-400 dark:border-gray-600 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                                    <option value="1" selected hidden>Pilih role</option>
                                    <option value="US">Admin</option>
                                    <option value="CA">manager</option>
                                    <option value="FR">staff</option>
                                </select>
