<div class="grid grid-cols-1 gap-4 p-4">
    <div class="flex flex-col">
        <div
            class="p-4 bg-white block sm:flex items-center rounded-t-lg justify-between border border-b-0 border-gray-200 lg:mt-1.5 dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div class="md:flex items-center mb-4 hidden sm:mb-0">
                        <div class="sm:pr-3">
                            ...
                            <div class="relative w-48 mt-1 sm:w-64 xl:w-96">
                                <input type="text" wire:model.live="search" name="email" id="products-search"
    ...
    <div id="drawer-create-product-default"
        class="fixed top-0 right-0 z-40 w-full h-screen max-w-xs p-4 overflow-y-auto transition-transform translate-x-full bg-white dark:bg-gray-800"
        tabindex="-1" aria-labelledby="drawer-label" aria-hidden="{{ session('openDrawer') ? 'false' : 'true' }}">
        <h5 id="drawer-label"
        ...
        <form action="{{ route('admin.product.data-produk.new') }}" method="POST">
            ...
            <div class="space-y-4">
                ...
                <div>
                    <label for="category-create"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Category</label>
                    <select id="category-create" name="category" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
